...
const publicKey = "4DnSWDeJynfS8O5lCJq1KnbeOydnwd8uq0yOa8fu";
...
const createOrder = async () => {
    ...
    if (useCCInput && !useCCInput.checked) { // Checking for checkout pages that have the 'id_use_cc' inputs
    ...
    if (!document.getElementById("id_same_as_shipping").checked) { // Checking for checkout pages that have the 'id_same_as_shipping' inputs
